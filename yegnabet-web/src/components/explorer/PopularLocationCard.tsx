  ...
  return (
    <button type="button" 
      ...
      <div className="flex size-10 items-center justify-center rounded-full bg-orange-50 
        text-yegna-500 transition-all duration-300 group-hover:scale-110 group-hover:bg-yegna-700 
        group-hover:text-white dark:bg-orange-500/10 dark:text-orange-400 
      ...
      <div className="leading-none">
        ...
        <p className="mt-1.5 text-[9px] font-medium text-gray-500 dark:text-white/50">
